...
def classify_regime(final_std, offset, anis, core, split):
    """
    Conservative, pragmatic classification for the interactive app.
    This is not the paper classification.
    """
    # Soft instability score: lower is better
    instability = (
    ...
    if instability < 0.55:
        return instability, "stable"
    if instability < 0.95:
        return instability, "meta-stable"
    return instability, "unstable"
...
def run_simulation(**params):
    ...
    instability_score, stability = classify_regime(final_std, offset, anis, core, split)
    ...
    print(f"stability_index={instability_score:.6f}")
